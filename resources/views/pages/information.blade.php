@include('shareable.header')
    ...
    <div class="content-wrapper">
        ...
        <h2 style="text-align:center; margin-top:30px;" class="align-center">Add Company Information</h2>
            ...
            <div class="card-body ">
                    ...
                    @csrf
                        ...
                        <!-- Gallery Information  -->
                        <div class="form-group">
                            <h3 style="color:orange; font-weight:bold;">Gallery Information</h3>
                            <div class="row mt-4">
                                <div class="col-12 mt-2">
                                    <label style="display:block;" class="form-label" for="cover_photo">Choose Cover Photo</label>
