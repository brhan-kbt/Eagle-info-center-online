...
<!-- Mirrored from code-theme.com/html/listifind/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Oct 2022 12:04:53 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>Eagle Information Center-Listing Directory Website In Ethiopia</title>
    <!-- FAVICON -->
...
<body class="homepage-2">
    ...
    <div id="wrapper">
            ...
            <div id="header" class="head-tr bottom">
                <div class="container container-header">
                    ...
                    <div class="left-side">
                        <!-- Logo -->
                        <div id="logo">
                            <a href="index.html"><img src="./assets/images/logo-white-blue.svg" data-sticky-logo="images/logo-blue.svg" alt=""></a>
                        </div>
                        <!-- Mobile Navigation -->
                    ...
                    <div class="header-image left h1 col-12 col-md-7 col-lg-6" data-aos="fade-right">
                        <div class="welcome-intro">
                            <div class="left wow fadeInLeft">
                                <h1>The best way to find your best place</h1>
                                <p>With over 400,000 active listings, DirectoryPlus has the largest inventory of listings in the United States..</p>
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <div class="footer mt-3 img-2">
                                            <a href="listing-details.html">
                                                <img src="css/colors/icons/purple/2.png" width="20" class="mr-2" alt=""> Restaurant
                                            </a>
                                            <span>
                                ...
                                <div class="project-single">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <div class="footer mt-3 img-3">
                                            <a href="listing-details.html">
                                                <img src="css/colors/icons/purple/3.png" width="20" class="mr-2" alt=""> Fitness
                                            </a>
                                            <span>
                                ...
                                <div class="project-single no-mb mbp-3">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <div class="footer mt-3 img-4">
                                            <a href="listing-details.html">
                                                <img src="css/colors/icons/purple/4.png" width="20" class="mr-2" alt=""> Cafe
                                            </a>
                                            <span>
                                <i class="fas fa-lock-open"></i> Open Now
                            </span>
                                ...
                                <div class="project-single">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <div class="footer mt-3 img-7">
                                            <a href="listing-details.html">
                                                <img src="css/colors/icons/purple/7.png" width="20" class="mr-2" alt=""> Rent a Car
                                            </a>
                                            <span>
                                <i class="fas fa-lock-open"></i> Open Now
                            </span>
                                ...
                                <div class="project-single">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <div class="footer mt-3 img-1">
                                            <a href="listing-details.html">
                                                <img src="css/colors/icons/purple/1.png" width="20" class="mr-2" alt=""> Hotel
                                            </a>
                                            <span>
                                <i class="fas fa-lock"></i> Closed Now
                            </span>
                                ...
                                <div class="project-single no-mb mbp-3">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <div class="footer mt-3 img-8">
                                            <a href="listing-details.html">
                                                <img src="css/colors/icons/purple/8.png" width="17" class="mr-2" alt=""> Shopping
                                            </a>
                                            <span>
                                <i class="fas fa-lock-open"></i> Open Now
                            </span>
            ...
            <div class="container">
                ...
                <div class="row service-1">
                    <article class="col-lg-4 col-md-6 col-xs-12 serv">
                        <div class="serv-flex" data-aos="fade-up">
                            <div class="art-1 img-13">
                                <img src="./assets/css/colors/icons/purple/13.png" alt="">
                    ...
                    <article class="col-lg-4 col-md-6 col-xs-12 serv">
                        <div class="serv-flex" data-aos="fade-up">
                            <div class="art-1 img-14">
                                <img src="./assets/css/colors/icons/purple/14.png" alt="">
                    ...
                    <article class="col-lg-4 col-md-6 col-xs-12 serv mb-0 pt">
                        <div class="serv-flex arrow" data-aos="fade-up">
                            <div class="art-1 img-15">
                                <img src="./assets/css/colors/icons/purple/15.png" alt="">
        ...
        <section class="feature-categories bg-white">
            <div class="container">
                <div class="sec-title">
        ...
        <section class="info-help">
            <div class="container">
                <div class="row info-head">
                    ...
                    <div class="featured popular portfolio freelancers home18 item col-lg-4 col-md-6 landscapes sale" data-aos="fade-left">
                    ...
                    <div class="featured popular portfolio freelancers home18 item col-lg-4 col-md-6 people landscapes rent no-pb" data-aos="fade-left">
        ...
        <section class="testimonials">
            <div class="container">
                <div class="sec-title">
                    ...
                    <p class="mb-0">Here is what people say about ListiFind.</p>
                </div>
                <div class="owl-carousel style1">
                    <div class="test-1" data-aos="zoom-in">
                        <p class="mb-0">Lorem ipsum dolor sit amet, ligula magna at etiam aliquip venenatis. Vitae sit felis donec, suscipit tortor et sapien donec.</p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="netabout">
                                <a href="index.html" class="logo">
                                    <img src="./assets/images/logo-white-blue.svg" alt="netcom">
                                </a>
                            ...
                            <div class="widget">
                                ...
                                <ul class="photo">
                                    <li class="hover-effect">
                                        <figure>
                                            <a href="#"><img src="./assets/images/instagram/inst-1.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li class="hover-effect">
                                        <figure>
                                            <a href="#"><img src="./assets/images/instagram/inst-2.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li class="hover-effect">
                                        <figure>
                                            <a href="#"><img src="./assets/images/instagram/inst-3.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li class="hover-effect">
                                        <figure>
                                            <a href="#"><img src="./assets/images/instagram/inst-4.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li class="hover-effect">
                                        <figure>
                                            <a href="#"><img src="./assets/images/instagram/inst-5.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li class="hover-effect">
                                        <figure>
                                            <a href="#"><img src="./assets/images/instagram/inst-6.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li class="hover-effect mb-0">
                                        <figure>
                                            <a href="#"><img src="./assets/images/instagram/inst-7.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li class="hover-effect mb-0">
                                        <figure>
                                            <a href="#"><img src="./assets/images/instagram/inst-8.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li class="hover-effect mb-0">
                                        <figure>
                                            <a href="#"><img src="./assets/images/instagram/inst-9.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                </ul>
                            </div>
        ...
        <script src="./assets/js/slick3.js"></script>
...
<!-- Mirrored from code-theme.com/html/listifind/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Oct 2022 12:04:56 GMT -->
</html>
