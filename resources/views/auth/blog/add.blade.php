                            ...
                            <div class="form-group">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4 mt-2">
                                        ...
                                        <select class="form-select form-control" name="blog_category" required>
                            ...
                            <div class="form-group">
                                <div class="row mt-4">
                                    <div class="col-12 mt-2">
                                        ...
                                        <textarea class="form-control" name="descripton" id="description" cols="30" rows="10" placeholder="Description"></textarea>
                                    </div>
                                </div>
                            </div> 
